...
Revision ID: 97ecb3a6525a
Revises: 45d9e4847f99
Create Date: 2019-07-07 23:38:58.993532
...
revision = '97ecb3a6525a'
down_revision = '45d9e4847f99'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('date_purchase', sa.DateTime(), server_default=sa.text("now('bay gio la')"), nullable=True),
